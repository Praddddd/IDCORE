...
<div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col col-md-3 col-xl-2 px-sm-2 px-0 bg-white" id="header">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100 ">
                ...
                <ul class="nav nav-pills flex-column mb-sm-3 mb-0 align-items-center align-items-sm-start">
                    <li class="nav-item text-white">
                        <a href="<?= BASEURL; ?>/login/logout" onclick="return confirm('Anda Yakin?')" class="nav-link align-middle px-0 text-danger">
                            Logout
                        </a>
                    </li>
                </ul>	
